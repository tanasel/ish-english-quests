(function () {
  ...
  function render() {
    ...
    brand.append(el("p", "kicker", "ISH English Department"), el("h1", "wordmark", "Quest Forge"), el("p", "lede", "Build and play curriculum quest packs: escape rooms and treasure hunts that run offline in a browser."));
    ...
    actions.append(build, open, readingControls());
